...
public class PagenationAdmin {
    ...
    //펫시터
    //화원리스트
    public static SelectPetSitterCriteria getPetSitterSelectCriteria(int page, int totalCount, int limit, int buttonAmount, String searchCondition, String searchValue, String apply) {
        /* 총 페이지 수 계산 */
        int maxPage = (int) Math.ceil((double) totalCount / limit);
        ...
        return new SelectPetSitterCriteria(page, totalCount, limit, buttonAmount, maxPage, startPage, endPage,
                startRow, endRow, searchCondition, searchValue, apply);
    }
}

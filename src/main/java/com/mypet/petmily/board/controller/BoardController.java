...
public class BoardController {
    ...
    public ModelAndView boardList( @PathVariable("boardType") String boardType, BoardDTO boardDTO) throws Exception {
		...
		if(boardDTO.getBoardSort() == "1" || boardDTO.getBoardSort() == "2") {
			//페이징을위한 총개수 가져오기
    ...
    public ModelAndView boardWrite(@PathVariable("boardType") String boardType, BoardDTO boardDTO) throws Exception {
    ...
    public ModelAndView boardView(@PathVariable("boardType") String boardType, BoardDTO boardDTO) throws Exception {
